...
public class ClientSSZukoMemory extends ClientEntitiesMemory
{
//    @SideOnly(Side.CLIENT)
...
//    @SideOnly(Side.CLIENT)
    ...
    public ClientSSZukoMemory(SkinningEntities skinningentities, BothData bothdata, WorkBytes workbytes)
    {
