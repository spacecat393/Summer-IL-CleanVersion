...
public class ClientSSHimiMemory extends ClientEntitiesMemory
{
//    @SideOnly(Side.CLIENT)
...
//    @SideOnly(Side.CLIENT)
    ...
    public ClientSSHimiMemory(SkinningEntities skinningentities, BothData bothdata, WorkBytes workbytes)
    {
