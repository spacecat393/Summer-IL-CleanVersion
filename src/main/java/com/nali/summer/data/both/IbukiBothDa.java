...
public class IbukiBothDa<SD extends ISoundLe> extends IBothDaNs<SD> implements IBothDaSn, IBothDaNe
{
    public static ISoundLe ISOUNDLE = new IbukiSound();
    public static IbukiBothDa IBOTHDASN = new IbukiBothDa(ISOUNDLE);

    public static byte MAX_FRAME = 1;
    public static byte MAX_SYNC = 1;

    public IbukiBothDa(SD sd)
    {
        super(sd);
    }
