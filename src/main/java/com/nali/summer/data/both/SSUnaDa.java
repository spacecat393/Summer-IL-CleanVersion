...
public class SSUnaDa<SD extends ISoundLe> extends IBothDaNs<SD> implements IBothDaSn, IBothDaNe
{
    public static ISoundLe ISOUNDLE = new SSUnaSound();
    public static SSUnaDa IBOTHDASN = new SSUnaDa(ISOUNDLE);

    public static byte MAX_FRAME = 1;
    public static byte MAX_SYNC = 1;

    public SSUnaDa(SD sd)
    {
        super(sd);
    }
