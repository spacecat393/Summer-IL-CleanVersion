...
public class MixAISSShizuko<SD extends ISoundDaLe, BD extends BothDaSSShizuko<SD>, E extends EntityLeInv, I extends IMixLe<SD, BD, E>, S extends ServerSleInv<SD, BD, E, I, ?>> extends MixAIEInv<SD, BD, E, I, S>
{
