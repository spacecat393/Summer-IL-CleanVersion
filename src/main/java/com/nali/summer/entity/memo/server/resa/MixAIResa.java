...
public class MixAIResa<SD extends ISoundDaLe, BD extends BothDaResa<SD>, E extends EntityLeInv, I extends IMixLe<SD, BD, E>, S extends ServerSleInv<SD, BD, E, I, ?>> extends MixAIEInv<SD, BD, E, I, S>
{
    ...
    public void init()
    {
        ...
        aileattack.minimum_distance = 12.0F;
    }
}
