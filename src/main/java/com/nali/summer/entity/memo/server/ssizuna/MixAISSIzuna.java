...
public class MixAISSIzuna<SD extends ISoundDaLe, BD extends BothDaSSIzuna<SD>, E extends EntityLeInv, I extends IMixLe<SD, BD, E>, S extends ServerSleInv<SD, BD, E, I, ?>> extends MixAIEInv<SD, BD, E, I, S>
{
    ...
    public void init()
    {
        ...
        aileattack.max_magic_point = 8;
        aileattack.minimum_distance = 6.0F;
    }
}
