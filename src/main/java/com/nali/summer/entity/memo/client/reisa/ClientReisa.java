...
import com.nali.summer.entity.sound.SoundReisa;
...
<
	...
	R extends RenderReisa<IE, E, I, MC, MB, MR, ?, BD, RC>,
...
> extends ClientLeInv<IE, RC, R, BD, E, I, MC, MB, MR> implements IClientERsInv, IClientESound
{
	...
	public SoundReisa soundreisa = new SoundReisa();
	...
	@Override
	public SoundReisa getSound()
	{
		return this.soundreisa;
	}
