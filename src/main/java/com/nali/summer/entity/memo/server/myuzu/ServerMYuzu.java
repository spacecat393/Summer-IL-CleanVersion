...
import com.nali.small.entity.memo.server.ai.frame.attack.FrameSleAttack;
...
public class ServerMYuzu<SD extends ISoundDaLe, BD extends IBothDaNe & IBothDaSn, E extends EntityLeInv, I extends IMixLe<SD, BD, E>, MS extends MixSIE<SD, BD, E, I, ?>> extends ServerSleInv<SD, BD, E, I, A>
{
