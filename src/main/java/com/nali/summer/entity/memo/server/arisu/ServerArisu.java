...
public class ServerArisu<IE extends InvLe, SD extends ISoundDaLe, BD extends IBothDaNe & IBothDaSn, E extends EntityLeInv, I extends IMixE<SD, BD, E>, MS extends MixSIE<SD, BD, E, I, ?>> extends ServerLeInv<IE, SD, BD, E, I, MS> implements IServerS
{
