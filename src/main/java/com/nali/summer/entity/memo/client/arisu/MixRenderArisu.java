...
public class MixRenderArisu<RC extends IClientDaS, R extends RenderS<BD, RC>, SD extends ISoundDaLe, BD extends IBothDaNe & IBothDaSn, E extends EntityLivingBase, I extends IMixLe<SD, BD, E>, MB extends MixBoxSle<RC, R, SD, BD, E, I, ?, C>, C extends ClientSle<RC, R, SD, BD, E, I, MB, ?>> extends MixRenderSleInv<RC, R, SD, BD, E, I, MB, C>
{
    public MixRenderArisu(C c)
    {
        super(c);
    ...
    public void multiplyAnimation()
    {
        ...
        R r = this.c.r;
        head_m4x4.multiply(r.skinning_float_array, 28*16);
