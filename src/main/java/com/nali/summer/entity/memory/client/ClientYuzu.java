...
public class ClientYuzu extends ClientEntitiesMemory
{
//    @SideOnly(Side.CLIENT)
...
//    @SideOnly(Side.CLIENT)
    ...
    public ClientYuzu(SkinningEntities skinningentities, BothData bothdata, WorkBytes workbytes)
    {
    ...
    {
        return ClientYuzu.IV_INT_ARRAY;
    }
}
