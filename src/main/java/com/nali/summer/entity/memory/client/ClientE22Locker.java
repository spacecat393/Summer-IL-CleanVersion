...
public class ClientE22Locker extends ClientEntitiesMemory
{
//    @SideOnly(Side.CLIENT)
...
//    @SideOnly(Side.CLIENT)
    ...
    public ClientE22Locker(SkinningEntities skinningentities, BothData bothdata, WorkBytes workbytes)
    {
    ...
    {
        return ClientE22Locker.IV_INT_ARRAY;
    }
}
