...
public class ClientIroha extends ClientEntitiesMemory
{
//    @SideOnly(Side.CLIENT)
...
//    @SideOnly(Side.CLIENT)
    ...
    public ClientIroha(SkinningEntities skinningentities, BothData bothdata, WorkBytes workbytes)
    {
    ...
    {
        return new IrohaRender(new EntitiesRenderMemory(), this.main_skinningentities);
    }
    ...
    {
        return ClientIroha.IV_INT_ARRAY;
    }
}
