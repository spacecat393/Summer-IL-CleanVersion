...
public class SummerMYuzuRender<T extends SummerMYuzu> extends SkinningEntitiesRender<T>
{
    public SummerMYuzuRender(RenderManager rendermanager)
    {
        super(rendermanager);
    }
    ...
    public void multiplyAnimation(T entities)
    {
        ...
        head_m4x4.multiply(skinningrender.skinning_float_array, 7*16);
