...
public class SummerNasuRender<T extends SummerNasu> extends SkinningEntitiesRender<T>
{
    public SummerNasuRender(RenderManager rendermanager)
    {
        super(rendermanager);
    }
    ...
    public void multiplyAnimation(T entities)
    {
        ...
        head_m4x4.multiply(skinningrender.skinning_float_array, 24 * 16);
