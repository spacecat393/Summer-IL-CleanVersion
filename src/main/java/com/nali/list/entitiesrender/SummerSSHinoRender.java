...
public class SummerSSHinoRender<T extends SummerSSHino> extends SkinningEntitiesRender<T>
{
    public SummerSSHinoRender(RenderManager rendermanager)
    {
        super(rendermanager);
    }
    ...
    public void multiplyAnimation(T entities)
    {
        ...
        head_m4x4.multiply(skinningrender.skinning_float_array, 34*16);
