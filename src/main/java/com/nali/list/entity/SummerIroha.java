...
public class SummerIroha extends EntityLe implements IMixES, IMixESInv
{
	public static int eggPrimary = 0xadb7c1;
	public static int eggSecondary = 0xc95b7e;

	public static DataParameter<Byte>[] BYTE_DATAPARAMETER_ARRAY = new DataParameter[BothDaIroha.IDA.E_MaxSync()];
