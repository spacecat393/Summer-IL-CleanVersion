...
public class SummerFRenderIroha<T extends SummerIroha> extends SkinningEntitiesRender<T>
{
    ...
    public void multiplyAnimation(T entities)
    {
        ...
        setAnimation(skinningrender);
    }

    public static void setAnimation(SkinningRender skinningrender)
    {
