...
import com.nali.summer.entity.memo.server.arisu.MixAIArisu;
import com.nali.summer.entity.memo.server.arisu.ServerArisu;
import com.nali.summer.entity.sound.SoundDaArisu;
...
//    }
    ...
    public byte[] getAI()
    {
        return MixAIArisu.AI_BYTE_ARRAY;
    }
    ...
    public void newC()
    {
        RenderArisu r = new RenderArisu(ClientDaArisu.ICLIENTDAS, BothDaArisu.IBOTHDASN);
        ClientArisu c = new ClientArisu(this, r, new Inventory(1));
    ...
    public void newS()
    {
        ServerArisu s = new ServerArisu(this, new Inventory(1));
        MixAIArisu a = new MixAIArisu(s);
        s.a = a;
        a.init();
        s.initFrame();
        this.ibothleinv = s;
    ...
    {
        RenderArisu r = new RenderArisu(ClientDaArisu.ICLIENTDAS, BothDaArisu.IBOTHDASN);
        ClientArisu c = new ClientArisu(null, r, new Inventory(1));
        r.c = c;
        c.mr = new MixRenderArisu(c);
        return c;
    }
