...
import com.nali.summer.entity.memo.client.resa.MixRenderResa;
import com.nali.summer.entity.memo.server.resa.MixAIResa;
import com.nali.summer.entity.memo.server.resa.ServerResa;
...
//    }
    ...
    public byte[] getAI()
    {
        return MixAIResa.AI_BYTE_ARRAY;
    }
    ...
    {
        return BothDaResa.IBOTHDASN;
    }

    @Override
    public Object getSD()
    {
        return SoundDaResa.ISOUNDDALE;
    }
