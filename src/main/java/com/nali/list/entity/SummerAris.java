...
public class SummerAris extends SkinningEntities
{
    ...
    public static BothData BOTHDATA = new ArisBothDa();
    public static WorkBytes WORKBYTES = new ArisBytes();
    public static Sounds SOUNDS = new ArisSound();

    public final static DataParameter<Byte>[] BYTE_DATAPARAMETER_ARRAY = new DataParameter[ArisBothDa.MAX_SYNC];
    public final static DataParameter<Integer>[] INTEGER_DATAPARAMETER_ARRAY = new DataParameter[ArisBothDa.MAX_FRAME];
